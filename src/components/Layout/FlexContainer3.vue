...
export default {
    ...
    computed: {
        ...
        formatLeftWidth() {
            ...
            const formatLeft = left || this.leftWidth || this.minLeft
            return formatLeft
        },
        ...
        leftBarX() {
            ...
            if(activeX) {
                ...
                activeX = this.leftWidth || this.minLeft
            }
            return activeX
        },
        ...
        formatTopHeight() {
            ...
            let formatTop = top || this.topHeight || this.minTop
            return formatTop
        },
        ...
        topBarY() {
            ...
            if(activeY) {
                ...
                activeY = this.topHeight || this.minTop
            }
            return activeY
        }
    },
