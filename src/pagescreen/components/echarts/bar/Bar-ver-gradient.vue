...
<script>
    ...
    import { maticsTransmit } from '../util/bar-mock-data'
    import * as echarts from 'echarts'
    export default {
        name: 'Bar-ver-gradient',
        components: {},
        mixins: [chartmixins],
        props: {
            chartData: {
                    ...
                    series: {
                        ...
                        itemStyle: {
                            normal: {
                                ...
                                color: new echarts.graphic.LinearGradient(0, 0, 1, 0, this.chartStyle.seriesColor),
                            },
                        },
                    }
                }
            ...
            chartStyleOptions() {
                ...
                return {
                    ...
                    series: {
                        itemStyle: {
                            normal: {
                                color: new echarts.graphic.LinearGradient(0, 0, 1, 0, seriesColor),
                            },
                        },
                    }
                }
        ...
        methods: {
            refreshMockData() {
                this.refreshApiData(maticsTransmit)
            },
