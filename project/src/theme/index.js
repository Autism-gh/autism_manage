...
import './main/blue.css'
import './main/night.css'
import './main/orange.css'

import { defaultVariables, extandVariables } from './defaultelement'
...
const themePlan = {
    blue: () => import('./colorset/blue.js'),

    night: () => import('./colorset/night.js'),
